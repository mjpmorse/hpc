...
import numpy as np
data = np.genfromtxt("q1_weak.dat",delimiter=",");
size = (data[:,0]-1)
time = data[:,1]
plt.figure(0)
...
plt.savefig('speedupq1_weak.png')
...
plt.savefig('inversespeedupq1_weak.png')
...
plt.savefig('speed_coresq1_weak.png')
